...
I use multibib to call them at different places.
...
In case a paper from `others.bib` is cited in the text, you need to have it both in `others.bib` and `refs_list.bib` with the same key, and remove the key from `nocite`.
Otherwise, the inline citation will appear will all the authors listed insted of "et al."
