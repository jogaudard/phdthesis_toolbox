...
I don't expect you to cite this repo if you just use it to write your own thesis.
However, if you want to disseminate it, or build on it, here is the citation:
...
bib <- ReadBib("/home/jga051/Dropbox/PhD/biblio_phd_zot.bib", check = FALSE)

# Select one entry (by key)

entry_key <- "phdthesis_toolbox"

# Get formatted citation (plain text)

cat(format(bib[[entry_key]], style = "text"))

# Print the BibTeX block

cat(" \n", " \n")
cat(toBibtex(bib[[entry_key]]), sep = "\n")

```

The original content of this repo is licensed under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/).
